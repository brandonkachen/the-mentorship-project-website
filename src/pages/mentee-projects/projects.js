...
const RickProject = (
  <div className="content is-showcase-page">
      ...
      <div className="tile is-parent">
        ...
        <figcaption>
          ...
          <figcaption>
            ...
            develop for the game. <br></br> Each item shown is a custom
            developed mod.
          </figcaption>
        </div>
      </div>
    ...
    <div className="tile is-ancestor">
      <div className="tile is-parent">
        <div className="tile is-child has-text-centered box">
          ...
          <figcaption>
            A guide to the year 2020, written by Carly in 2020 for Carly in
            2019.
          </figcaption>
        </div>
      </div>
      <div className="tile is-4 is-vertical is-parent">
        <div className="tile is-child box">
          ...
          <p>
            Carly was curious about design because she likes to draw and wanted
            to hone her storytelling skills. With her mentor Bijun's help, Carly
